        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <h1><strong>HIMASI </strong>UBSI PSDKU Karawang</h1>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <!-- <img src="" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic"> -->
                </div>
            </div>
        </div>
    </div>
...
<section class="section" id="about">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12 img" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <img src="<?= base_url('assets/img/about2.jpeg'); ?>" class="rounded img-fluid d-block mx-auto" alt="App">
            </div>
            <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                <div class="left-heading">
                    <h5>Himpunan Mahasiswa <br> Sistem Informasi UBSI PSDKU Kabupaten Karawang</h5>
                </div>
                <div class="left-text text-justify">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium architecto quaerat, nam necessitatibus accusamus beatae? Esse animi culpa tenetur blanditiis, consequuntur hic doloribus, explicabo laudantium assumenda, cumque reiciendis dolorem sequi porro vitae a corporis voluptates eum pariatur? Quibusdam dolore, accusamus rem iusto magni voluptate! Debitis consequuntur ratione nemo illo officiis?.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="left-text col-lg-6 col-md-12 col-sm-12 mobile-bottom-fix">
                <div class="left-heading">
                    <h5>Departemen yang ada di HIMASI</h5>
                </div>
                <p>Proin justo sapien, posuere suscipit tortor in, fermentum mattis elit. Aenean in feugiat purus.</p>
                <ul>
                    <li>
                        <img src="<?= base_url('assets/img/pendidikan.png'); ?>" alt="">
                        <div class="text">
                            <h6>Departemen Pendidikan</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quaerat magni ipsa unde, assumenda consequuntur quis vitae alias dolores! Cum!</p>
                        </div>
                    </li>
                    <li>
                        <img src="<?= base_url('assets/img/sosial.png'); ?>" alt="">
                        <div class="text">
                            <h6>Departemen Sosial</h6>
                            <p>You have no right to re-distribute this template as a downloadable ZIP file on any website.</p>
                        </div>
                    </li>
                    <li>
                        <img src="<?= base_url('assets/img/organisasi.png'); ?>" alt="">
                        <div class="text">
                            <h6>Departemen Keorganisasian</h6>
            ...
            <div class="right-image col-lg-6 col-md-12 col-sm-12 mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                <img src="<?= base_url('assets/img/img3.jpg'); ?>" class="rounded img-fluid d-block mx-auto" alt="App">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="owl-carousel owl-theme">
                <div class="item service-item">
                    <i><img src="<?= base_url('assets/img/img3.jpg'); ?>" alt=""></i>
                    <!-- <div class="icon">
                        </div> -->
